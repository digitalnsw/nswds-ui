...
const fillPanel =
  'flex items-center justify-center bg-muted p-4 text-sm text-muted-foreground'
const plainPanel =
  'flex items-center justify-center p-4 text-sm text-foreground'
...
const meta = {
  ...
  render: (args) => (
    <ResizablePanelGroup
      {...args}
      className="h-48 max-w-md rounded-md border border-border"
    >
