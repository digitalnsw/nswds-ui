      ...
      <div className='mx-auto max-w-7xl space-y-6 px-6 py-8'>
        <header className='space-y-3'>
          ...
          <p className='text-base text-muted-foreground'>
            ...
            — every entry inherits <code>currentColor</code>, so colour and size come from the
            surrounding utility classes.
          </p>
        </header>
        ...
        <div className='sticky top-0 z-10 -mx-6 border-b border-border bg-background/95 px-6 py-4 backdrop-blur supports-[backdrop-filter]:bg-background/75'>
          <div className='flex flex-col gap-2'>
            <label htmlFor='icon-search' className='text-sm font-medium text-foreground'>
              Search icons
            </label>
            <Input
              id='icon-search'
