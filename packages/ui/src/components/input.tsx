...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <InputPrimitive
      ...
      data-type={type}
      className={cn(
        // Layout, typography, base shape — Figma: 48px tall, 4px radius.
        ...
        // Default — 1px grey-01 border on surface-default
        'border border-grey-800 bg-background text-grey-800',
        // Dark mode — flip text to a light grey so it's readable on dark surface
        // (mirrors how border-grey-800 → dark:border-grey-200 is handled below).
        'dark:text-grey-100',
        // Hover — NSW blue tinted surface (Figma: link-hover-bg)
        'hover:bg-grey-100',
        // Focus — match Button: 2px NSW-blue outline offset by 2px. Uses `focus:`
        ...
        'dark:placeholder:text-grey-400',
        // Disabled
        ...
        'dark:border-grey-200 dark:bg-input/30',
        className
      )}
      {...props}
    />
