 ...
 * one resets the context at its portal — see `ButtonGroupBoundary`), and even
 * a type-only import of Button or ButtonGroup from here would make them a
 * registry dependency of Tooltip, Select and the rest. button.tsx narrows the
 ...
 * label colour on whatever surface the popup has. Every popup in this package
 * wraps its portal contents in this boundary; an overlay from another
 * library, opened from inside a group, should do the same.
 */
