...
| `@nswds/dialog`        | `Dialog`, `DialogClose`, `DialogContent`, `DialogDescription`, `DialogFooter`, `DialogHeader`, `DialogOverlay`, `DialogPortal`, `DialogTitle`, `DialogTrigger`, `DialogVariant`, `dialogContentVariants`                                                                                                                                                                                                                              | A modal window centred over the page, built on the Base UI dialog primitive, with an optional translatable close button. |
